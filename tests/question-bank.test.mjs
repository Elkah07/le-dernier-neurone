...
test("la base contient exactement 1 180 QCM valides", () => {
  assert.equal(bank.length, 1180);
  assert.equal(new Set(bank.map(question => question.question.toLowerCase())).size, 1180);
